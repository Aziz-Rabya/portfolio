      ...
      items-center justify-between lg:px-24 px-10 relative overflow-hidden '>
        ...
        <div className="z-40 xl:mb-0 mb-[20%]">
          ...
          className="text-xl md:text-1xl lg:text-2xl text-purple-200 max-w-2xl">
            I am a passionate developer dedicated to crafting high-performance web applications. My focus is on delivering seamless user experiences through clean, efficient, and scalable code.
          </motion.p>
        </div>
